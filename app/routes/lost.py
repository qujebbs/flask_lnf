...
def los():
        ...
        query = "SELECT u.colUsername, lp.colItemName, lp.colItemDesc, u.colEmail, lp.colDatePosted, pic.colPicURI, lp.colPosterID, lp.colItemID FROM tbl_items AS lp JOIN tbl_user AS u ON lp.colPosterID = u.colUserID left JOIN tbl_item_pic AS pic ON lp.colItemID = pic.colItemID and lp.colStatusID = 1 where lp.colStatusID = 1;"
